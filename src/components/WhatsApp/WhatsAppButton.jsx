...
const WhatsAppButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="whatsapp-btn fixed bottom-8 left-6 z-40 w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center"
